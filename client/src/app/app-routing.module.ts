...
import { InstructorEditComponent} from './pages/instructor-edit/instructor-edit.component';
...
const routes: Routes = [
    ...
    { path: 'instructors/:id',  loadChildren: './pages/instructor-edit/instructor-edit.module#InstructorEditModule' , canActivate: [AuthGuard] },
    { path: 'instructors',  loadChildren: './pages/instructor-list/instructor-list.module#InstructorListModule' , canActivate: [AuthGuard] },
