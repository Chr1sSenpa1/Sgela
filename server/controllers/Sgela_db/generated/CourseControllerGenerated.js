...
const generatedControllers = {
  ...
  init: router => {
    ...
    router.get(baseUrl + "/findBy_instructor/:key", authorize([]), CourseController.findBy_instructor);
  ...
  *
  */
  findBy_instructor: async (req, res) => {
    try {
      const result = await CourseModel.findBy_instructor(req.params.key);
      res.json(result);
    } catch (err) {
      const safeErr = ErrorManager.getSafeError(err);
      res.status(safeErr.status).json(safeErr);
